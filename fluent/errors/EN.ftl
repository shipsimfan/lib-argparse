...
MissingArgument = missing argument "{ $argument }"
MissingPositionalValue = missing "{ $value }"
InvalidPositionalValue = invalid "{ $value }" - { $error } 
...
CharInvalid = expected exactly 1 character
AddressInvalid = invalid address provided