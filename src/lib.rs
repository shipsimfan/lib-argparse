...
//! ### Flag Arguments
//!
//! [`FlagArgument`]s are arguments that start with a short prefix (default: `"-"`) or a long prefix (default: `"--"`)
...
//! The function can return the same types as an action flag.
//!
//! ### Terminal Arguments
...
//!
//! #### Positionals
//! [`Positionals`] and `None` form the leaves of the tree.
